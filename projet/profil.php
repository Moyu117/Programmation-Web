...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($lastName && !preg_match("/^[A-Za-zÀ-ÖØ-öø-ÿ\-' ]+$/u", $lastName)) {
        $errors[] = 'Le nom de famille contient des caractères invalides.';
    }

    if ($firstName && !preg_match("/^[A-Za-zÀ-ÖØ-öø-ÿ\-' ]+$/u", $firstName)) {
...
<main>
    <div class="container">
        ...
        <div class="user-info">
            ...
            <?php if ($user['lastName'] || $user['firstName']): ?>
                <p><strong>Nom complet:</strong> <?php echo htmlspecialchars($user['firstName'] . ' ' . $user['lastName']); ?></p>
			<?php else:?>
